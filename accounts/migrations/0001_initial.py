...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='following',
            field=models.ManyToManyField(related_name='followers', through='accounts.Network', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='network',
            index=models.Index(fields=['-created'], name='accounts_ne_created_9df718_idx'),
        ),
    ]
